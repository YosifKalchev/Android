...
public class ZackFragment extends NavigationFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_zack, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        txtView = view.findViewById(R.id.txtZack);


        BottomNavigationView btmNavZack = view.findViewById(R.id.btmNavZack);
        btmNavZack.setOnNavigationItemSelectedListener(item -> {
            switch (item.getItemId()) {
                case R.id.action_home: showHomeScreen(view, Direction.ZACK_SNYDER_TO_START.getValue()); break;
