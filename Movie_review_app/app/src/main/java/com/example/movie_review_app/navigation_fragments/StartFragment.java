...
public class StartFragment extends Fragment {
    ...
    private void setUpRecyclerView(View view) {
        ...
        Movie movie4 = new Movie("Mortal Kombat", 2021, 4,  Review.MORTAL_KOMBAT,
                Grade.OUTSTANDING, Crew.MORTAL_KOMBAT);
