...
public class BadBoysFragment extends NavigationFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_bad_boys, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        txtView = view.findViewById(R.id.txtBadBoys);


        BottomNavigationView btmNavBadBoys = view.findViewById(R.id.btmNavBadBoys);
        btmNavBadBoys.setOnNavigationItemSelectedListener(item -> {
            switch (item.getItemId()) {
                case R.id.action_home: showHomeScreen(view, Direction.BAD_BOYS_TO_START.getValue()); break;
