...
public class AvatarFragment extends NavigationFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        txtView = view.findViewById(R.id.txtAvatar);


        BottomNavigationView btmNavAvatar = view.findViewById(R.id.btmNavAvatar);
        btmNavAvatar.setOnNavigationItemSelectedListener(item -> {
            switch (item.getItemId()) {
                case R.id.action_home: showHomeScreen(view, Direction.AVATAR_TO_START.getValue()); break;
