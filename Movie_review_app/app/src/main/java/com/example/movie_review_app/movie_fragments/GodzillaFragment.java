...
public class GodzillaFragment extends NavigationFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_godzilla, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        txtView = view.findViewById(R.id.txtGodzilla);


        BottomNavigationView btmNavGodzilla = view.findViewById(R.id.btmNavGodzilla);
        btmNavGodzilla.setOnNavigationItemSelectedListener(item -> {
            switch (item.getItemId()) {
                case R.id.action_home: showHomeScreen(view, Direction.GODZILLA_TO_START.getValue()); break;
