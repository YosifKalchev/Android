...
public class MortalKombatFragment extends NavigationFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_mortal_kombat, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        txtView = view.findViewById(R.id.txtMortalKombat);


        BottomNavigationView btmNavMk = view.findViewById(R.id.btmNavMortalKombat);
        btmNavMk.setOnNavigationItemSelectedListener(item -> {
            switch (item.getItemId()) {
                case R.id.action_home: showHomeScreen(view, Direction.MORTAL_KOMBAT_TO_START.getValue()); break;
