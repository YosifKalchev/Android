...
public class TitansFragment extends NavigationFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_titans, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        txtView = view.findViewById(R.id.txtTitans);


        BottomNavigationView btmNavTitans = view.findViewById(R.id.btmNavTitans);
        btmNavTitans.setOnNavigationItemSelectedListener(item -> {
            switch (item.getItemId()) {
                case R.id.action_home: showHomeScreen(view, Direction.CLASH_OF_TITANS_TO_START.getValue()); break;
