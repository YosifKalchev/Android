...
//        view.findViewById(R.id.btnOne).setOnClickListener(this::goToNextScreen1);
    }

//    private void goToNextScreen1(View v) {
//        Navigation.findNavController(v).navigate(R.id.action_question1_to_question2);
//    }
}