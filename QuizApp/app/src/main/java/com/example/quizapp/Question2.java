...
//        view.findViewById(R.id.btnNext2).setOnClickListener(this::goToNextScreen2);
    }

//    private void goToNextScreen2(View v) {
//        Navigation.findNavController(v).navigate(R.id.action_question2_to_question3);
//    }
}