...
public class QuestionTwoFragment extends Fragment {
     ...
     * @return A new instance of fragment Question_2.
     */
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.txtView2).setOnClickListener(v -> goToNext(v));
    }

    private void goToNext(View v) {
        Navigation.findNavController(v).navigate(R.id.action_questionTwoFragment_to_questionThreeFragment);
    }
}